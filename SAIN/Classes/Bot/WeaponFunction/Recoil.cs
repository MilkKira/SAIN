...
{
    // ===== 新增：水平后坐力额外乘数，值越大横向散布越大 =====
    private const float HORIZONTAL_RECOIL_MULTIPLIER = 1.5f;
    // ===========================================================
    ...
    private void calculateRecoil(Weapon weapon)
    {
        ...
        // 水平方向：乘以额外的横向偏移乘数，增大左右摆动
        _currentRecoilHorizAngle = Random.Range(calcdRecoil / 3f, calcdRecoil) * randomSign() * HORIZONTAL_RECOIL_MULTIPLIER;
